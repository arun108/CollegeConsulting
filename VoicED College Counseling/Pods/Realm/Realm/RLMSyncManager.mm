...
- (NSUInteger)connectTimeout {
    return (uint32_t) _options.connect_timeout;
}
...
- (NSUInteger)connectLingerTime {
    return (uint32_t) _options.connection_linger_time;
}
...
- (NSUInteger)pingKeepalivePeriod {
    return (uint32_t) _options.ping_keepalive_period;
}
...
- (NSUInteger)pongKeepaliveTimeout {
    return (uint32_t) _options.pong_keepalive_timeout;
}
...
- (NSUInteger)fastReconnectLimit {
    return (uint32_t) _options.fast_reconnect_limit;
}
