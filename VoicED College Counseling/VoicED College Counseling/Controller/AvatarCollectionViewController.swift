...
//
//  Created by Arun Narayanan on 2/25/20.
...
class AvatarCollectionViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    let cellsPerRow = 5
    let avatarArray = Constants.avatarArray
    
    weak var parentViewcontroller: RegisterViewController?
    ...
    // MARK: - UICollectionViewDataSource. Avatar list that users can pick from
     ...
     func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let img : UIImage = UIImage(named: avatarArray[indexPath.row])!
        imageview.image = img
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let nameOfAvatar = avatarArray[indexPath.item]
